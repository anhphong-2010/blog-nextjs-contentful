...
export default function RecentPostItem(props) {
  ...
  return (
    <article
      className="p-4 rounded-lg bg-white dark:bg-gray-900 flex flex-col space-y-4 mb-3 sm:mb-6 "
      key={post.sys.id}
    >
      {!!_.get(post, "thumbnail.url") && (
        <div
          className="relative bg-slate-100 rounded-lg overflow-hidden border dark:border-white border-gray-500"
